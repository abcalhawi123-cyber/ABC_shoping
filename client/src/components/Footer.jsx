    ...
    <footer style={{ background: '#1a3a5c', color: '#fff', padding: '32px 24px 16px', marginTop: 'auto' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px,1fr))', gap: 32 }}>
        ...
        <div>
          ...
          <a href="https://wa.me/201212957890" target="_blank" rel="noopener noreferrer" style={linkStyle}>📱 01212957890</a>
          <a href="https://wa.me/201270530308" target="_blank" rel="noopener noreferrer" style={linkStyle}>📱 01270530308</a>
        </div>
        <div>
          <h4 style={{ color: '#f8ad9d', margin: '0 0 12px' }}>{t('followUs')}</h4>
          <a href="https://www.instagram.com/abcalhawi123/#" target="_blank" rel="noopener noreferrer" style={linkStyle}>📸 Instagram</a>
          <a href="https://www.facebook.com/profile.php?id=61590921087512" target="_blank" rel="noopener noreferrer" style={linkStyle}>👍 Facebook</a>
          <a href="https://www.tiktok.com/@abcalhawi" target="_blank" rel="noopener noreferrer" style={linkStyle}>🎵 TikTok</a>
        </div>
        <div>
...
const linkStyle = { display: 'block', color: '#fff', textDecoration: 'none', fontSize: 13, marginBottom: 6, opacity: 0.85 };
