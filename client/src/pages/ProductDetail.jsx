  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:description" content={product.metaDescription || description?.substring(0, 160)} />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, marginBottom: 40 }}>
              ...
              {product.images.map((img, i) => (
                <img
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    border: i === mainImage ? '2px solid #f8ad9d' : '2px solid transparent',
                  }}
                />
              ))}
            </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 16 }}>
            ...
            {product.discount > 0 && (
              <>
                ...
                <span style={{ background: '#ffeaa7', color: '#d35400', padding: '2px 8px', borderRadius: 12, fontSize: 13, fontWeight: 600 }}>
          ...
          {/* Stock */}
          <p style={{ marginBottom: 20, fontWeight: 600, color: product.stock < 5 && product.stock > 0 ? '#e74c3c' : product.stock === 0 ? '#e74c3c' : '#27ae60' }}>
            {product.stock === 0 ? '✗ غير متوفر' : product.stock < 5 ? `⚠ ${product.stock} قطع فقط متبقية!` : `✓ متوفر (${product.stock} قطعة)`}
          </p>
